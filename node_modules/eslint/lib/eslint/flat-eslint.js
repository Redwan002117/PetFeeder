...
class FlatESLint {
        ...
        const results = await Promise.all(
            ...
            filePaths.map(filePath => {
                ...
                try {
                    ...
                    // Handle errors from getConfig, such as those caused by whitespace in globals
                    debug(`Error getting config for ${filePath}: ${error.message}`);
                    config = null;
                }
    ...
    async lintText(code, options = {}) {
        ...
        try {
            ...
            // Handle errors from getConfig, such as those caused by whitespace in globals
            debug(`Error getting config for ${resolvedFilename}: ${error.message}`);
            config = null;
        }
    ...
    async calculateConfigForFile(filePath) {
        ...
        try {
            ...
            // Handle errors from getConfig, such as those caused by whitespace in globals
            debug(`Error getting config for ${absolutePath}: ${error.message}`);
            return undefined;
        }
    }
    ...
    async isPathIgnored(filePath) {
        try {
            ...
            // If we can't get the config due to errors, treat the path as not ignored
            debug(`Error checking if path is ignored for ${filePath}: ${error.message}`);
            return false;
        }
    }
}
