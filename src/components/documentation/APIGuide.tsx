        ...
        <AccordionItem value="authentication" id="authentication">
          ...
          <AccordionContent>
            <div className="space-y-4">
              ...
              <p>The PetFeeder API uses Supabase Authentication. Include your Supabase JWT token in the Authorization header:</p>
        ...
        <AccordionItem value="websocket">
          ...
          <AccordionContent>
            <div className="space-y-4">
              ...
              <pre className="bg-gray-100 p-4 rounded-md">
                <code>
                  {`ws://api.petfeeder.com/ws?token={supabase-jwt-token}
